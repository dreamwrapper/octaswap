export const LBC_MAINNET_ADDRESS = '0x8DbC9F88b1a6292BaC0E8a214AD5223703aeB506' as `0x${string}`;
export const LBC_MAINNET_ABI = [
...
export const lbcMainnetContractConfig = {
  abi: LBC_MAINNET_ABI,
  address: LBC_MAINNET_ADDRESS,
};
